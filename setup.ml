...
(* OASIS_START *)
(* DO NOT EDIT (digest: 05c9ded6d6e07c83f503081b04e64320) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Lazy_trie"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "lazy-trie";
     ...
     oasis_digest =
       Some "\003\200+\243@\138\021q\242\151\188f\148\173\004\003";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
